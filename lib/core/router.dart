...
import '../domain/use_cases/create_post_usecase.dart'; // Added this import
...
final CreatePostUseCase createPostUseCase = CreatePostUseCase(repository); // Added this instance
final FeedNotifier feedNotifier = FeedNotifier(getPostsUseCase, createPostUseCase); // Updated this line
